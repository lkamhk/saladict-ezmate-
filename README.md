...
-   輸入英文：用中文解釋意思，再檢查文法同用字。
-   輸入中文或中英夾雜：理解你想表達嘅意思，提供自然英文。
-   需要修改時：使用較易理解嘅 **CEFR B1 程度**英文，並將修改後句子放入方便複製嘅程式碼區塊。
-   原句冇問題時：直接指出毋須修改，唔為改而改。

以上係預設提示詞嘅目標；你可以自行修改 Prompt，調整語氣、程度同輸出格式。
